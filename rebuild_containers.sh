...
docker rmi threatguard-3.0-master-api 2>/dev/null || true
docker rmi threatguard-3.0-master-snort-integration 2>/dev/null || true
docker rmi threatguard-3.0-master-web 2>/dev/null || true
